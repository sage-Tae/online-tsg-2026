...
pairs at $k<n-1$. A structural obstruction (Corollary 18): a bounded
...
the single-vehicle insertion identity. A multi-vehicle *Online
Vehicle Routing Game* — requiring $c(S)$ redefined with capacity and
a fleet-assignment rule — is the subject of a companion manuscript
in preparation.

## Submission history disclosure

This manuscript was previously submitted to *Transportation Science*
(TS-2026-0253) and was desk-rejected on scope grounds; the editor
indicated the paper would need to include "more generalizable knowledge
for the field of transportation science" before going out for review.
We agree the cooperative-game-theoretic framing is closer to *EJOR*'s
remit than to *Transportation Science*'s operational-decision focus,
and accordingly resubmit to *EJOR* without retargeting the
manuscript's substance. The manuscript has not been published or
submitted elsewhere.
